package com.olegis.p0821_handleravdmessage;
...
public class MainActivity extends AppCompatActivity {
    ...
    final int STATUS_DOWNLOAD_NONE = 6; //нет фалов для загрузки
        ...
        Thread t = new Thread(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    //загрузка начинается
                    //создаем сообщение, c информацией о колличестве файлов
                    ...
                    for (int i = 1; i <= filesCount; i++) {
                        ...
                        //файла,
                        //колличеством оставшихся и самим файлом
